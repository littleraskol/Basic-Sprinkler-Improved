    ...
    class BasicSprinklerImproved : Mod
    {
        ...
        WateringPattern LoadPatternFromConfigFile(string fileName = "")
        {
            ...
            else
            {
                ...
                myConfig = this.Helper.Data.ReadJsonFile<ModConfig>(fileName);
                loadedName = fileName;
            }
        ...
        void Event_SavePattern(object sender, EventArgs e)
        {
            ...
            lastUsed = toWater;
            this.Helper.Data.WriteJsonFile<ModConfig>(backupFile, new ModConfig(lastUsed.myType, lastUsed.myPattern));
